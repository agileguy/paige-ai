...
# PAI Branding (lime green theme)
PAI_BRAND='\033[1;38;2;132;204;22m'   # Bold lime green for "Paige"
PAI_BRAND_LIGHT='\033[38;2;163;230;53m' # Light lime for accents
PAI_A='\033[38;2;132;204;22m'         # Lime green (used in ENV line)
PAI_LABEL='\033[38;2;100;116;139m'    # Slate for labels
...
case "$MODE" in
    nano)
        printf "${SLATE_600}── │${RESET} ${PAI_BRAND}Paige${RESET} ${SLATE_600}│ ────────────${RESET}\n"
    ...
    micro)
        if [ -n "$session_display" ]; then
            ...
            printf "${SLATE_600}── │${RESET} ${PAI_BRAND}Paige${RESET} ${SLATE_600}│ ${local_dashes}${RESET} ${PAI_SESSION}${session_display}${RESET}\n"
        else
            printf "${SLATE_600}── │${RESET} ${PAI_BRAND}Paige${RESET} ${SLATE_600}│ ──────────────────${RESET}\n"
        fi
